//
//  ZHInformationDetailViewController.m
//  ShiShiYaoWen
//
...
#define ZHINFORMATIONDETAILVIEWCONTROLLER @"ZHInformationDetailViewController"

@interface ZHInformationDetailViewController ()

@end

@implementation ZHInformationDetailViewController
{
...
{
    ZHInformationCellModel *cellModel = [[ZHInformationCellModel alloc] init];
    cellModel.categoryname = model.categoryName;
    cellModel.categoryid = model.categoryId;
    cellModel.title = model.title;
    cellModel.titleimg = model.titleImg;
    cellModel.pubdate = model.pubDate;
    cellModel.descripString = model.descrip;
    cellModel.contenturl = model.contentUrl;
    cellModel.newsid = model.newsId;
    cellModel.contentHtmlUrl = model.contentHtmlUrl;
    cellModel.author = model.Author;
    cellModel.praise = model.praise;
    cellModel.belittle = model.belittle;
    self = [self initWithModel:cellModel];
    return self;
}
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    [MTA trackPageViewBegin:ZHINFORMATIONDETAILVIEWCONTROLLER];
}

- (void)viewDidDisappear:(BOOL)animated
{
    [super viewDidDisappear:animated];
    [MTA trackPageViewEnd:ZHINFORMATIONDETAILVIEWCONTROLLER];
}
