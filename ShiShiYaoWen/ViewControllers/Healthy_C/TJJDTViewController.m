...
@implementation TJJDTViewController
...
- (void)updateData{
    _titleLb.text = _data.name;
    //功能
    _jj.text = [NSString stringWithFormat:@"功能:\n%@",[self convertString:_data.func]];
    ...
    _pl.text = [NSString stringWithFormat:@"简介:\n%@",[self convertString:_data.as]];
    ...
    //提示
    _bzq.text = [NSString stringWithFormat:@"小提示:\n%@",[self convertString:_data.note]];
...
- (void)startRequest{
    NSString *url = [NSString stringWithFormat:TJJDTURL,self.Sid];
    ...
    [op setCompletionBlockWithSuccess:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        _data = [[HealthDTModel alloc] init];
        NSDictionary *dc = dict[@"data"];
        [_data setValuesForKeysWithDictionary:dc];
        [self updateData];
